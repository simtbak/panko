...
DECLARE enumerate_schemas CURSOR FOR 
				SELECT 'tsc' [name]
	UNION ALL	SELECT 'state'
	UNION ALL	SELECT 'delta'
	UNION ALL	SELECT 'report';

OPEN enumerate_schemas 
FETCH NEXT FROM enumerate_schemas INTO @name
...
BEGIN
	...
	END
END
CLOSE enumeraet_schemas;
DEALLOCATE enumerate_schemas;
